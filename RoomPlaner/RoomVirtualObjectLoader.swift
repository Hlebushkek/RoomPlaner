...
*/
class RoomVirtualObjectLoader {
    private(set) var loadedObjects = [RoomVirtualObject]()
    ...
    */
    func loadVirtualObject(_ object: RoomVirtualObject, loadedHandler: @escaping (RoomVirtualObject) -> Void) {
        isLoading = true
